defmodule SchoolAdmissionWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SchoolAdmissionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SchoolAdmissionWeb.Gettext, "errors", msg, opts)
    end
  end
